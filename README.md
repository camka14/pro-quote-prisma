...
- The generator output is currently set to `../pro-quote-next/generated/prisma` to keep the Next.js app imports stable. Update the generator `output` path if you mount this schema in a different project layout.
